<?php 
    const images = ["business", "city", "nature", "transport"];
?>

<?php function outputHeader() { ?>
    <header>
...
<?php function outputFooter() { ?>
    <footer>
      <p>&copy; Fake News, 2022</p>
    </footer>
<?php } ?>

<?php function outputMenu() { ?>
    <nav id="menu">
...
<?php function printArticleFooter(array $article, int $commentCount = 0) { ?>
  <footer>
    ...
    <a class="comments" href="#comments"><?= $commentCount ?></a>
  </footer>
<?php } ?>